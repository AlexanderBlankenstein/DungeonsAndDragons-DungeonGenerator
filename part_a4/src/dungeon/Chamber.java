...
public class Chamber extends Space implements Serializable {
	...
	public void addSetMonster(Monster theMonster){
		monsters.add(theMonster);
	}

	public void removeMonster(int monsterChoice){
		getMonsters().remove(monsterChoice);
	}
	...
	public void addSetTreasure(Treasure theTreasure){
		theTreasure.setContainer(Die.d20());
		treasures.add(theTreasure);
	}

	public void removeTreasure(int treasureChoice){
		getTreasureList().remove(treasureChoice);
	}
	...
	public String getDescription(){
        ...
        if ((monsters.size()!=0 || treasures.size()!=0) && myContents.getDescription().contains("empty")){
            description += "\nContents: ";
        } else {
